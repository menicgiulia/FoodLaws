function nuttablestat=script_fit_nutrients_different_truncation(nuttablestat, fooddatabase0910selclean, muf,sf)


vTrunc=100;
%nuttablestat=nutlistSrandommodel0(:,1:3);
...
%         nuttablestat.ksstatN(ind)=nan; 
    ...
    disp(nuttablestat.muNt(ind))
    disp(nuttablestat.sigmaNt(ind))
